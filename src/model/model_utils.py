...
model_dirs = {
    ...
    'gemma-2-12b-it': 'google/gemma-2-12b-it',
    'gemma-12b-it': 'google/gemma-2-12b-it'
}
...
def load_model(args, model_name=None, peft_path=None):
    ...
    elif model_name in ["phi3-small", "phi3-medium", "phi-3-mini-4k-instruct", "phi-3-medium-4k-instruct"] :
    ...
    elif model_name in ["gemma-3-0.27b-it", "gemma-3-270m-it", "gemma-3-1b-it", "gemma-3-1.1b-it", "gemma-3-4b-it", "gemma-3-12b-it", "gemma-3-27b-it", "gemma-2-12b-it", "gemma-12b-it"] :
